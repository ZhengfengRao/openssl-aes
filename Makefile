...
LIB=libcrypto.a
LIBSRC= $(SRC_DIR)/aes_core.c $(SRC_DIR)/aes_misc.c $(SRC_DIR)/aes_ecb.c $(SRC_DIR)/aes_cbc.c $(SRC_DIR)/aes_cfb.c $(SRC_DIR)/aes_ofb.c \
 $(SRC_DIR)/aes_ctr.c $(SRC_DIR)/aes_ige.c $(SRC_DIR)/aes_wrap.c
LIBOBJ=$(SRC_DIR)/aes_misc.o $(SRC_DIR)/aes_ecb.o $(SRC_DIR)/aes_cfb.o $(SRC_DIR)/aes_ofb.o $(SRC_DIR)/aes_ctr.o $(SRC_DIR)/aes_ige.o $(SRC_DIR)/aes_wrap.o \
 $(SRC_DIR)/aes_core.o $(SRC_DIR)/aes_cbc.o
